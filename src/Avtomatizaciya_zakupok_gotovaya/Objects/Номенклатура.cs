...
namespace IIS.Avtomatizaciya_zakupok_gotovaya
{
    ...
    public class Номенклатура : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupok_gotovaya.ЕдиницыИзмер fЕдиницыИзмер;
        ...
        [PropertyStorage(new string[] {
                "ЕдиницыИзмер"})]
        [NotNull()]
        public virtual IIS.Avtomatizaciya_zakupok_gotovaya.ЕдиницыИзмер ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupok_gotovaya.ЕдиницыИзмер result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НоменклатураE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НоменклатураE", typeof(IIS.Avtomatizaciya_zakupok_gotovaya.Номенклатура));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НоменклатураL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НоменклатураL", typeof(IIS.Avtomatizaciya_zakupok_gotovaya.Номенклатура));
                }
            }
        }
    }
