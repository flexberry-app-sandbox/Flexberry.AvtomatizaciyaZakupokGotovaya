...
namespace IIS.Avtomatizaciya_zakupok_gotovaya
{
    ...
    public class ПланЗакупок : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupok_gotovaya.DetailArrayOfПлан fПлан;
        ...
        public virtual IIS.Avtomatizaciya_zakupok_gotovaya.DetailArrayOfПлан План
        {
            get
            {
                ...
                if ((this.fПлан == null))
                {
                    this.fПлан = new IIS.Avtomatizaciya_zakupok_gotovaya.DetailArrayOfПлан(this);
                }
                IIS.Avtomatizaciya_zakupok_gotovaya.DetailArrayOfПлан result = this.fПлан;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокE", typeof(IIS.Avtomatizaciya_zakupok_gotovaya.ПланЗакупок));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокL", typeof(IIS.Avtomatizaciya_zakupok_gotovaya.ПланЗакупок));
                }
            }
        }
    }
