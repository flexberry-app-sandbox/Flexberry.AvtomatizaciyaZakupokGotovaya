...
namespace IIS.Avtomatizaciya_zakupok_gotovaya
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupok_gotovaya.Номенклатура fНоменклатура;
        
        private IIS.Avtomatizaciya_zakupok_gotovaya.ОтчетОЗак fОтчетОЗак;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.Avtomatizaciya_zakupok_gotovaya.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupok_gotovaya.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Avtomatizaciya_zakupok_gotovaya.ОтчетОЗак.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.Avtomatizaciya_zakupok_gotovaya.ЗаказПост",
                "IIS.Avtomatizaciya_zakupok_gotovaya.ОтчетОЗак"})]
        public virtual IIS.Avtomatizaciya_zakupok_gotovaya.ОтчетОЗак ОтчетОЗак
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupok_gotovaya.ОтчетОЗак result = this.fОтчетОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Avtomatizaciya_zakupok_gotovaya.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Avtomatizaciya_zakupok_gotovaya.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Avtomatizaciya_zakupok_gotovaya.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Avtomatizaciya_zakupok_gotovaya.ОтчетОЗак fОтчетОЗак) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fОтчетОЗак)))
        {
        }
        
        public IIS.Avtomatizaciya_zakupok_gotovaya.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Avtomatizaciya_zakupok_gotovaya.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Avtomatizaciya_zakupok_gotovaya.ТЧЗаказ dataobject)
        {
