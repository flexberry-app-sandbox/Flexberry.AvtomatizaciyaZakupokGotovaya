...
moduleForModel('i-i-s-avtomatizaciya-zakupok-gotovaya-номенклатура', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok-gotovaya-номенклатура', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok-gotovaya-номенклатура',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
