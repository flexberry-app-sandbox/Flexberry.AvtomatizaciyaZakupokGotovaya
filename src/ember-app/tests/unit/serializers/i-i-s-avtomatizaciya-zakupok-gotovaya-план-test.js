...
moduleForModel('i-i-s-avtomatizaciya-zakupok-gotovaya-план', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok-gotovaya-план', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok-gotovaya-план',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
