...
moduleForModel('i-i-s-avtomatizaciya-zakupok-gotovaya-организации', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok-gotovaya-организации', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok-gotovaya-организации',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
