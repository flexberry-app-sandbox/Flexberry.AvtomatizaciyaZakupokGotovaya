...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok gotovaya заказ пост l');

test('testing i-i-s-avtomatizaciya-zakupok-gotovaya-заказ-пост-l', function(assert) {
