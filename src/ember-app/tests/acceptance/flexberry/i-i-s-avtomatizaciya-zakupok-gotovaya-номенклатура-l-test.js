...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok gotovaya номенклатура l');

test('testing i-i-s-avtomatizaciya-zakupok-gotovaya-номенклатура-l', function(assert) {
