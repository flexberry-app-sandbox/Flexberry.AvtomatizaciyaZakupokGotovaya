...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok gotovaya план закупок l');

test('testing i-i-s-avtomatizaciya-zakupok-gotovaya-план-закупок-l', function(assert) {
