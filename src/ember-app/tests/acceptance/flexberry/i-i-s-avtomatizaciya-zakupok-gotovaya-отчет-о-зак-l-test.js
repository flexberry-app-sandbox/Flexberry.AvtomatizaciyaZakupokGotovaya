...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok gotovaya отчет о зак l');

test('testing i-i-s-avtomatizaciya-zakupok-gotovaya-отчет-о-зак-l', function(assert) {
