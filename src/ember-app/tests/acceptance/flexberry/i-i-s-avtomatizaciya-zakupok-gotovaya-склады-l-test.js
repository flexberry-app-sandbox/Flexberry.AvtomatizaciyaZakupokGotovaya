...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok gotovaya склады l');

test('testing i-i-s-avtomatizaciya-zakupok-gotovaya-склады-l', function(assert) {
