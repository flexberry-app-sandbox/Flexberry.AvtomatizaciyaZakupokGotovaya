...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok gotovaya контрагенты l');

test('testing i-i-s-avtomatizaciya-zakupok-gotovaya-контрагенты-l', function(assert) {
