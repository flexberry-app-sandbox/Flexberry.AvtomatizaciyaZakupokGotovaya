...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok gotovaya единицы измер l');

test('testing i-i-s-avtomatizaciya-zakupok-gotovaya-единицы-измер-l', function(assert) {
